...
const Home = () => {
  return (
    ...
    >
      <Carousel/>
      <Container>
        <h2 className='d-flex linea home-title justify-content-center'>Nuestro Café</h2>
        <div className='pt-5 pb-5 d-flex justify-content-around'>
          <img className='img-home px-2' src={cafe} alt="cafe recien servido"></img>
